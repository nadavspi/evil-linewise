...
(defun evil-linewise/copy-previous-line (count)
...
(defun evil-linewise/copy-next-line (count)
...
(define-key evil-normal-state-map (kbd "[ y") 'evil-linewise/copy-previous-line)
(define-key evil-normal-state-map (kbd "] y") 'evil-linewise/copy-next-line)
